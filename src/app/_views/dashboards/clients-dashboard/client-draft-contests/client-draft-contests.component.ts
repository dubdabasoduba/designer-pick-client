...
@Component({
	selector: 'app-client-draft-contests',
	templateUrl: './client-draft-contests.component.html',
	styleUrls: ['./client-draft-contests.component.css']
})
export class ClientDraftContestsComponent implements OnInit {
	loading = false;
	...
	private updateLiveContests(contests: Array<ContestModel>) {
		...
		for (let i = 0; i < contests.length; i++) {
			...
			newContests.push(ClientDraftContestsComponent.generateNewContest(contest));
		}
