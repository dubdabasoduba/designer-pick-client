...
import {Acquisitions, ContactModel, Entity, Founders, Funding, Industry, PagesModel, Person, Work} from '../_models';
...
export class AppCommons {
	...
	/**
	 * @desc Creates an industry model object
	 * @param model {@link Industry}
	 * @author dubdabasoduba
	 */
	...
	/**
	 * @desc Updates the main industry of operation
	 * @param model {@link any}
